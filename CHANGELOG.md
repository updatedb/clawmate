...
- **Dir 面板不再关闭右侧面板**：展开 Dir 面板曾无条件关闭项目面板与 Agent 面板；项目面板（col3）与 Dir（col1）本就是独立列、设计上共存。现在 >1500px 与 769–1240px 共存；1241–1500px 维持 content-first 抑制（Agent 终端占真实列、需要宽度）；≤767px 两者都是全屏浮层，保持互斥。
